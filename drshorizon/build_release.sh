...
cargo build -Z build-std=core,alloc,std,panic_abort -Z json-target-spec --target aarch64-nintendo-switch.json --release
...
nacptool --create 'doukutsu-rs' 'doukutsu-rs contributors' '1.0.0' target/aarch64-nintendo-switch/release/drshorizon.nacp
